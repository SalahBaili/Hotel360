      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity
            ...
            disabled={loading}
          >
            {loading ? <ActivityIndicator color="#fff" /> : <Text style={styles.signupButtonText}>Créer le compte</Text>}
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  form: {
    backgroundColor: '#fff', borderTopLeftRadius: 40,
    borderTopRightRadius: 40, padding: 35, paddingTop: 40, minHeight: 550,
  },
  inputContainer: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#F7F8FA',
    borderRadius: 14, paddingHorizontal: 15, marginBottom: 15, height: 58,
