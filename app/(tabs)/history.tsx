...
const eventsData = [
  {
    ...
    type: "login",
    icone: "🔐",
    message: "Connexion admin — salah@hotel360.com",
    heure: "22:12",
    date: "Aujourd'hui",
  },
  {
    ...
    type: "alerte",
    icone: "🌡️",
    message: "Alerte température — Chambre 104 (28°C)",
    heure: "22:05",
    date: "Aujourd'hui",
  },
  {
    ...
    type: "auto",
    icone: "❄️",
    message: "Clim allumée automatiquement — Chambre 102",
    heure: "21:30",
    date: "Aujourd'hui",
  },
  {
    ...
    type: "alerte",
    icone: "🪟",
    message: "Fenêtre ouverte détectée — Chambre 103",
    heure: "21:48",
    date: "Aujourd'hui",
  },
  {
    ...
    type: "auto",
    icone: "💡",
    message: "Lumière éteinte automatiquement — Chambre 105",
    heure: "20:15",
    date: "Aujourd'hui",
  },
  {
    ...
    type: "login",
    icone: "🔐",
    message: "Connexion réceptionniste — ahmed@hotel360.com",
    heure: "08:00",
    date: "Hier",
  },
  {
    ...
    type: "alerte",
    icone: "⚡",
    message: "Consommation anormale — Chambre 201",
    heure: "14:30",
    date: "Hier",
  },
  {
    ...
    type: "auto",
    icone: "❄️",
    message: "Clim éteinte — Chambre vide depuis 3h (205)",
    heure: "12:00",
    date: "Hier",
  },
];
      ...
      <View style={styles.onglets}>
        ...
        >
          <Text
            style={[
              styles.ongletText,
              onglet === "stats" && styles.ongletTextActive,
            ]}
          >
            📈 Statistiques
          </Text>
        ...
        >
          <Text
            style={[
              styles.ongletText,
              onglet === "events" && styles.ongletTextActive,
            ]}
          >
            📋 Événements
          </Text>
          ...
          <View style={styles.resumeGrid}>
            <View style={[styles.resumeCard, { backgroundColor: "#1565C0" }]}>
              <Text style={styles.resumeNumber}>
                {Math.round(
                  historiqueData.reduce((a, d) => a + d.occupancy, 0) /
            ...
            <View style={[styles.resumeCard, { backgroundColor: "#F57C00" }]}>
              <Text style={styles.resumeNumber}>
                {Math.round(
                  historiqueData.reduce((a, d) => a + d.tempMoy, 0) /
                    historiqueData.length,
                )}
                °C
              </Text>
            ...
            <View style={[styles.resumeCard, { backgroundColor: "#2E7D32" }]}>
              <Text style={styles.resumeNumber}>
                {Math.round(
                  historiqueData.reduce((a, d) => a + d.consommation, 0) /
                    historiqueData.length,
                )}
                W
              </Text>
            ...
            {historiqueData.map((d, i) => (
              ...
              >
                ...
                <Text
                  style={[
                    styles.tableCell,
                    { color: d.occupancy > 80 ? "#E53935" : "#64B5F6" },
                  ]}
                >
                  {d.occupancy}%
                </Text>
                <Text style={[styles.tableCell, { color: "#F57C00" }]}>
                  {d.tempMoy}°C
                </Text>
                <Text
                  style={[
                    styles.tableCell,
                    { color: d.alertes > 2 ? "#E53935" : "#ccc" },
                  ]}
                >
                  {d.alertes}
                </Text>
